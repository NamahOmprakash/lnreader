...
export interface StringMap {
  ...
  'customCodeSettings.description': 'string';
  'customCodeSettings.textRules': 'string';
  'customCodeSettings.ruleCount.one': 'string';
  'customCodeSettings.ruleCount.other': 'string';
  'customCodeSettings.activeSnippetCount.one': 'string';
  'customCodeSettings.activeSnippetCount.other': 'string';
  'customCodeSettings.addReplaceRule': 'string';
  'customCodeSettings.addRemoveRule': 'string';
  'customCodeSettings.renameHint': 'string';
  ...
  'customCodeSettings.regexHint': 'string';
  ...
  'customCodeSettings.beautifyCode': 'string';
  'customCodeSettings.beautifyFailed': 'string';
  'customCodeSettings.syntaxHighlighting': 'string';
  'customCodeSettings.importCode': 'string';
